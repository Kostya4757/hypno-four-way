...
leftMissoffsets = {'29', '0'}  -- you probably won't need these if it's for the opponent
downMissoffsets = {'30', '-92'}  --
upMissoffsets = {'-24', '23'}    --
rightMissoffsets = {'-11', '17'} --
...
idle_xml_name = 'GOLD IDLE'
left_xml_name = 'GOLD RIGHT POSE0'
down_xml_name = 'GOLD DOWN POSE0'
up_xml_name = 'GOLD UP POSE0'
right_xml_name = 'GOLD LEFT POSE0'

left_miss_xml_name = 'GOLD RIGHT POSE MISS'   -- you probably won't need these if it's for the opponent
down_miss_xml_name = 'GOLD DOWN POSE MISS'   --
up_miss_xml_name = 'GOLD UP MISS'       --
right_miss_xml_name = 'GOLD LEFT POSE MISS' --
...
name_of_character_xml = 'GoldCold'
name_of_character = 'GoldCold'
name_of_notetype = 'DuetNote'
name_of_notetype2 = 'TeamNote' -- for multiple characters singing at the same time
...
function onCreate()
	...
	addAnimationByPrefix(name_of_character, 'idle', idle_xml_name, 18, true);
