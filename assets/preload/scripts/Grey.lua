...
idleoffsets = {'17', '11'} -- I recommend you have your idle offset at 0
leftoffsets = {'15', '9'}
downoffsets = {'16', '9'}
upoffsets = {'19', '9'}
rightoffsets = {'15', '9'}

leftMissoffsets = {'15', '9'}  -- you probably won't need these if it's for the opponent
downMissoffsets = {'16', '9'}  --
upMissoffsets = {'15', '9'}    --
rightMissoffsets = {'15', '9'} --
...
idle_xml_name = 'Grey_I'
left_xml_name = 'Grey_L'
down_xml_name = 'Grey_D'
up_xml_name = 'Grey_U'
right_xml_name = 'Grey_R'

left_miss_xml_name = 'Grey_Miss_L'   -- you probably won't need these if it's for the opponent
down_miss_xml_name = 'Grey_Miss_D'   --
up_miss_xml_name = 'Grey_Miss_U'       --
right_miss_xml_name = 'Grey_Miss_R' --
...
function onCreate()
	...
	setProperty('Grey.antialiasing',false)
